...
| [optimization-playbook.md](optimization-playbook.md) | The live perf method: the iteration ladder (cheapest reject first, per-step costs), A/B rules, measurement traps, profiling recipe, landed/rejected/remaining tables |
| [optimization-sessions.md](optimization-sessions.md) | Append-only history of the perf sessions (2026-09-07 →): per-session narratives, measurement forensics, the patch-isolation study |
