...
visible to any S75 meter) → **0058–0065 round eleven, the device access
...
the S75's vCPU against ~24 % for the guest's own code.  Eight patches
...
idle round (0065).  Two things generalise: **a store to a
